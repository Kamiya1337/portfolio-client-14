            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="bg-academic-blue text-white border-b border-academic-hero-blue">
                  <th className="p-3 font-bold border-r border-academic-border/40 w-1/4">Tiêu chí chấm điểm</th>
                  <th className="p-3 font-bold border-r border-academic-border/40 w-2/5">Yêu cầu tiêu chuẩn Xuất sắc (8.1 - 10)</th>
                  <th className="p-3 font-bold border-r border-academic-border/40">Mức độ tự đánh giá hiện tại</th>
              ...
              <tbody className="divide-y divide-slate-200 text-slate-700">
                {rubric.map((item, idx) => (
                  <tr key={idx} className="hover:bg-slate-50/50">
                    ...
                    <td className="p-3 italic text-academic-muted">{item.action}</td>
                  </tr>
                ))}
              </tbody>
            </table>
