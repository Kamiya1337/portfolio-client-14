        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-3">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Trạng thái minh chứng thật: Đã tích hợp thành công <span className="font-bold text-academic-blue bg-academic-cream px-2 py-0.5 rounded border border-academic-border">{completedMilestones} trên {totalMilestones}</span> mục dữ liệu.
            </p>
          </div>
          <span className="text-3xl font-black text-academic-blue tracking-tight">{progressPercent}%</span>
        </div>
        <div className="w-full bg-academic-cream rounded-full h-3.5 overflow-hidden border border-academic-border">
          <div 
      ...
      <div className="bg-academic-card rounded-2xl shadow-sm border border-academic-border overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="bg-academic-blue text-academic-cream text-sm">
            ...
            <tbody className="divide-y divide-slate-200 text-sm">
              ...
              <tr className="hover:bg-academic-cream transition-colors">
                ...
                <td className="p-4">
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-bold border bg-academic-cream text-academic-blue border-academic-border">
                  ...
                  <tr key={project.id} className="hover:bg-academic-cream transition-colors">
                    ...
                    <td className="p-4">
                      <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-bold border ${
                        isFullyDone 
                          ? "bg-academic-cream text-academic-blue border-academic-border" 
                    ...
                    <td className={`p-4 text-xs italic font-medium ${isFullyDone ? "text-slate-400 line-through" : "text-academic-muted"}`}>
                      {isFullyDone 
                        ? "Đã đồng bộ" 
